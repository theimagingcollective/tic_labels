...
if __name__ == "__main__":
     ...
     parser.add_argument("--csv",             help="CSV Filename (default=imageFile.csv).", default='image_compare.csv') 
     ...
     if inArgs.debug:
         ...
         print "inArgs.label_filename  = " +  inArgs.label_filename
         print "inArgs.image1_filename       = " +  str(inArgs.image1_filename)
         print "inArgs.image2_filename       = " +  str(inArgs.image2_filename)
         print "inArgs.csv          = " +  str(inArgs.csv)
         print
     ...
     input_files = [[ inArgs.image1_filename,        ":colormap=grayscale:grayscale=0,4096" ],
                    [ inArgs.image2_filename,        ":colormap=grayscale:grayscale=0,4096" ],
                    [ inArgs.label_filename,  ":colormap=jet:opacity=0.5" ]]
     ...
     if  inArgs.qi:
         util.freeview( input_files, True )    
